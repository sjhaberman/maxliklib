//Maximum likelihood is applied to a partial-credit IRT model
...
//Set quadrature.
    ...
    for(i=0;i<nr;i++)
    {
         ...
         selectbeta(i).list.head(nmax(i))=regspace<uvec>(k,k+nmax(i)-1);
         selectbeta(i).list(nmax(i))=d-1;
         k=k+nmax(i);
    }
