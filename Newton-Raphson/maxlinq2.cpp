...
// By reordering if needed, f.value(y1)is at least f.value(y2).
    ...
    stepmax,upper,width;
// vy1 gives value, gradient, and Hessian of f at y1, vy2 is correponding information at y2,
