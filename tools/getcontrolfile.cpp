...
//The file includes multiple lines of text.
//Each line has two strings that are separated by
//a blank character. Each of these strings contains no blank character.
//The first string is a key word defining the nature of the entry.
//The second string is the value associated
