//Save quadrature weights, kernels, points, and associated value, gradient, and Hessian
//of log likelihood component.  fflag indicates file saving,
...
void savpwrf2v(const int & order , const field<field<pwrf2v>> & vlm, const string & out,
